                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:openSansHelvetica,Arial,sans-serif;font-size:20px;font-weight:600;line-height:1;text-align:center;color:#000000;"><span>Order has been placed🎉</span></div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:14px;line-height:1;text-align:left;color:#000000;">
                          <h4>Hi ${username}👋,</h4>
                          <p> We have received your order. We will send you an email when your order is ready. You can also check your order status on click of the button below. </p>
                        </div>
                      </td>
                    </tr>
                    <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                          <tr>
                            <td align="center" bgcolor="#84bc00" role="presentation" style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#84bc00;" valign="middle">
                              <a href="${process.env.FRONTEND_URL}/order/${id}" style="display:inline-block;background:#84bc00;color:#ffffff;font-family:open Sans Helvetica, Arial, sans-serif;font-size:14px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;" target="_blank"> View Order Status &rarr; </a>
                            </td>
                          </tr>
                        </table>
                      </td>
